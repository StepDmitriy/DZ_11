...
@app.route('/cearch/<candidate_name>')
def cearch_candidate_page(candidate_name):
    candidates: list[dict] = get_candidates_by_name(candidate_name)
    return render_template('search.html', candidates=candidates)


@app.route('/cearch/<candidate_name>')
def cearch_candidate_bay_name_page(candidate_name):
    candidates: list[dict] = get_candidates_by_name(candidate_name)
    return render_template('search.html', candidates=candidates)


@app.route('/skill/<skill_name>')
def cearch_candidate_bay_skill_page(skill_name):
